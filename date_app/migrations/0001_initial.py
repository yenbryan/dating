    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dater_image', models.ForeignKey(related_name=b'images', to=settings.AUTH_USER_MODEL)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user1', models.ForeignKey(related_name=b'matches', to=settings.AUTH_USER_MODEL)),
                ('user2', models.ForeignKey(related_name=b'user_2_match', to=settings.AUTH_USER_MODEL)),
            ],
            options={
            },
            bases=(models.Model,),
